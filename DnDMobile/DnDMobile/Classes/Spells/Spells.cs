	...
	class Spells
	{
		public static List<Spell> All = new List<Spell>() {
				...
				new Spell()
				{
					...
					Level = "2",
					CastingTime = "1 Action",
					Range = "30 feet (then another 30 feet in chosen direction)",
				...
				new Spell()
				{
					...
					Source = "PHB 211",
					AtHigherLevel = "-",
					CastableBy = "Cleric, Paladin, Artificer (UA), Domain (Protection), Domain (Solidarity)",
				...
				new Spell()
				{
					...
					Source = "PHB 211",
					AtHigherLevel = "-",
					CastableBy = "Ranger, Wizard, Artificer (UA)",
				...
				new Spell()
				{
					...
					AtHigherLevel = "-",
					CastableBy = "-",
					Description = "Deprecated. This spell was not included in the final release of the Artificer (5e) class (see Eberron Rising from the Last War)."
				},
				new Spell()
				{
				...
				new Spell()
				{
					...
					Description = "You touch a willing creature. Until the spellends, the target’s skin has a rough, bark-like appearance, and the target’s AC can’t be less than 16, regardless of what kind of armor it is wearing. "
				},
				new Spell()
				{
					Name = "Beacon of Hope",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "PHB 218",
					AtHigherLevel = "When you cast this spell using a spell slot of 6th level or higher, the damage from the clenched fist option increases by 2d8 and the damage from the grasping hand increases by 2d6 for each slot level above 5th.",
					CastableBy = "Artificer, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "-",
					Source = "PHB 219",
					AtHigherLevel = "When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.",
					CastableBy = "Bard, Circle Of Spores, Cleric, Death Domain, Sorcerer, The Fiend, The Undying, The Undead, Wizard,",
				...
				new Spell()
				{
					...
					AtHigherLevel = "-",
					CastableBy = "Sorcerer, Wizard",
					Description = "A daz z ling array of flashing, colored light springs from your hand. Roll 6d10, the total is how many hit points of creatures this spell can effect. Creatures in a 15-foot cone originating from you are affected in ascending order of their current hit points (ignoring unconscious creatures and creatures that can’t see). Starting with the creature that has the lowest current hit points, each creature affected by this spell is blinded until the spell ends. Subtract each creature’s hit points from the total before moving on to the creature with the next lowest hit points. A creature’s hit points must be equal to or less than the remaining total for the creature to be affected."
				},
				new Spell()
				{
					Name = "Command",
				...
				new Spell()
				{
					...
					Description = "For the duration, you understand the literal meaning of any spoken language that you hear. You also understand any spoken language that you hear. You also understand any written language that you see, but you must be touching the surface of which the words are written. It takes about 1 minute to read one page of text. This spell doesn’t decode secret messages in a text or glyph, such as an arcane sigil, that isn’t part of a written language. "
				},
				new Spell()
				{
					Name = "Compulsion",
				...
				new Spell()
				{
					...
					Description = "This spell assaults and twists creatures’ minds, spawning delusions and provoking uncontrolled actions. Each creature in a 10-footradius sphere centered on a point you choose within range must succeed on a Wisdom saving throw when you cast this spell or be affected by it. An affected target can’t take reactions and must roll a d10 at the start of each of its turns to determine its behavior for that turn. d10 Behavior 1. The creature uses all its movement to move in a random direction. To determine the direction, roll a d8 and assign a direction to each die face. The creature doesn’t take an action this turn. 2-6. The creature doesn’t move or take actions this turn. 7-8. The creature uses its action to make a melee attack against a randomly determined creature within its reach. If there is no creature within its reach, the creature does nothing this turn. 9-10. The creature can act and move normally. At the end of its turns, an affected target can make a Wisdom saving throw. It it succeeds, this effect ends for that target."
				},
				new Spell()
				{
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "XGE 154",
					AtHigherLevel = "When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d6 for each slot level above 2nd.",
					CastableBy = "Sorcerer, Wizard",
				...
				new Spell()
				{
					...
					Source = "PHB 237",
					AtHigherLevel = "-",
					CastableBy = "Artificer, Sorcerer, Wizard",
				...
				new Spell()
				{
					...
					Source = "PHB 238",
					AtHigherLevel = "-",
					CastableBy = "The Great Old One, The Lurker In the Deep, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "PHB 251",
					AtHigherLevel = "When you cast this spell using a spell slot of 3rd or 4th level, you can maintain your concentration on the spell for up to 8 hours. When you use a spell slot of 5th level or higher, you can maintain your concentration on the spell for up to 24 hours.",
					CastableBy = "Oath Of Vengeance, Ranger",
				...
				new Spell()
				{
					...
					Description = "S warming, biting locusts fill a 20-foot-radius sphere centered on a point you choose within range. The sphere spreads around corners. The sphere remains for the duration, and its area is lightly obscured. The sphere’s area is difficult terrain. When the area appears, each creature in it must make a Constitution saving throw. A creature takes 4d10 piercing damage on a failed save, or half as much damage on a successful one. A creature must also make this saving throw when it enters the spell’s area for the first time on a turn or ends its turn there."
				},
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "TCE 107",
					AtHigherLevel = "When you cast this spell using a spell slot of 4th level or higher, you can target one additional creature for each slot level above 3rd. The creatures must be within 30 feet of each other when you target them.",
					CastableBy = "Artificer, Bard, Sorcerer, Warlock, Wizard",
				...
				new Spell()
				{
					...
					Source = "PHB 254",
					AtHigherLevel = "-",
					CastableBy = "Arcana Domain, Artificer, Wizard",
				...
				new Spell()
				{
					...
					Source = "PHB 255",
					AtHigherLevel = "-",
					CastableBy = "Bard, Twilight Domain, Wizard",
				...
				new Spell()
				{
					...
					AtHigherLevel = "-",
					CastableBy = "Warlock, Wizard",
					Description = "Magical darkness spreads from a point you choose within range to fill a 60—foot—radius sphere until the spell ends. The darkness spreads around corners. A creature with darkvision can’t see through this darkness. Nonmagical light, as well as light created by spells of 8th level or lower, cant illuminate the area. Shrieks, gibbering, and mad laughter can be heard within the sphere. Whenever a creature starts its turn in the sphere, it must make a Wisdom saving throw, taking 8d8 psychic damage on a failed save, or half as much damage on a successful one. "
				},
				new Spell()
				{
					Name = "Maelstrom",
				...
				new Spell()
				{
					...
					CastableBy = "Alchemist, Circle (Land), Wizard",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "EE 161",
					AtHigherLevel = "When you cast this spell using a spell slot of 4th level or higher, the number of meteors created increases by two for each slot level above 3rd.",
					CastableBy = "Sorcerer, Wizard",
				...
				new Spell()
				{
					...
					Level = "4",
					CastingTime = "10 Minutes",
					Range = "120 feet (5-100 foot cube)",
					...
					Concentration = "-",
					Source = "PHB 262",
					AtHigherLevel = "When you cast this spell using a spell slot of 5th level or higher, you can increase the size of the cube by 100 feet for each slot level beyond 4th. Thus you could protect a cube that can be up to 200 feet on one side by using a spell slot of 5th level.",
					CastableBy = "Artificer, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "-",
					Source = "PHB 263",
					AtHigherLevel = "When you cast this spell using a spell slot of 7th level or higher, the damage increases by 1d6 for each slot level above 6th.",
					CastableBy = "Wizard",
				...
				new Spell()
				{
					...
					Source = "PHB 264",
					AtHigherLevel = "-",
					CastableBy = "Artificer, Oath of Redemption, Wizard",
				...
				new Spell()
				{
					...
					Source = "PHB 264",
					AtHigherLevel = "-",
					CastableBy = "Circle (Grassland), Domain (Trickery), Druid, Ranger",
				...
				new Spell()
				{
					...
					Source = "PHB 270",
					AtHigherLevel = "-",
					CastableBy = "Domain (Unity), Wizard",
				...
				new Spell()
				{
					...
					AtHigherLevel = "-",
					CastableBy = "Wizard",
					Description = "By means of this spell, a willing creature of an object can be hidden away, safe from detection for the duration. When you cast the spell and touch the target, it becomes invisible and can’t be targeted by divination spells or perceived through scrying sensors created by the divination of spells. If the target is a crreature, it falls into a state of suspended animation. Time ceases to flow for it, and it doesn’t grow older. You can set a condition for the spell to end early. The condition can be anything you choose, but it must occur or be visible within 1 mile of the target. Examples include after 1,000 years or when the tarrasque awakes. This spells also ends if the target takes any damage. "
				},
				new Spell()
				{
					Name = "Shadow Blade",
				...
				new Spell()
				{
					...
					Description = "Until the spell ends, freez ing rain and sleet fall in a 20-foot-tall cylinder with a 40-foot radius centered on a point you choose within range. The area is heavily obscured, and exposed flames in the area are doused. The ground in the area is covered with slick ice, making it difficult terrain. When a creature enters the spell’s area for the first time on a turn or starts its turn there, it must make a Dexterity saving throw. On a failed save, it falls prone. If a creature is concentrating in the spell’s area, the creature must make a successful Constitution saving throw against your spell save DC or lose concentration. "
				},
				new Spell()
				{
					Name = "Slow",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "TCE 108",
					AtHigherLevel = "When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d8 for every two slot levels above 3rd.",
					CastableBy = " Cleric, Paladin, Warlock, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "TCE 109",
					AtHigherLevel = "When you cast this spell using a spell slot of 5th level or higher, use the higher level wherever the spell’s level appears in the stat block.",
					CastableBy = " Warlock, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "-",
					Source = "TCE 109",
					AtHigherLevel = "When you cast this spell using a spell slot of 3rd level or higher, use the higher level wherever the spell’s level appears in the stat block.",
					CastableBy = "Druid, Ranger",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "TCE 110",
					AtHigherLevel = "When you cast this spell using a spell slot of 6th level or higher, use the higher level wherever the spell’s level appears in the stat block.",
					CastableBy = "Cleric, Paladin",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "TCE 111",
					AtHigherLevel = "When you cast this spell using a spell slot of 4th level or higher, use the higher level wherever the spell’s level appears in the stat block.",
					CastableBy = "Artificer, Wizard",
				...
				new Spell()
				{
					...
					Source = "TCE 112",
					AtHigherLevel = "When you cast this spell using a spell slot of 4th level or higher, use the higher level wherever the spell’s level appears in the stat block.",
					CastableBy = "Druid, Ranger, Warlock, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "TCE 112",
					AtHigherLevel = "When you cast this spell using a spell slot of 7th level or higher, use the higher level wherever the spell’s level appears in the stat block.",
					CastableBy = "Warlock, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "Yes",
					Source = "TCE 115",
					AtHigherLevel = "When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 2d4 for each slot level above 1st.",
					CastableBy = "Artificer, Sorcerer, Wizard",
				...
				new Spell()
				{
					...
					Source = "PHB 280",
					AtHigherLevel = "-",
					CastableBy = "Arcane Trickster, Bard, Eldritch Knight, The Great Old One, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "-",
					Source = "TCE 115",
					AtHigherLevel = "When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd. The creatures must be within 30 feet of each other when you target them.",
					CastableBy = "Sorcerer, Wizard",
				...
				new Spell()
				{
					...
					Source = "PHB 288",
					AtHigherLevel = "-",
					CastableBy = "Sorcerer, The Genie, Wizard",
				...
				new Spell()
				{
					...
					Concentration = "-",
					Source = "XGE 171",
					AtHigherLevel = "The spell’s damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6).",
					CastableBy = "Cleric",
