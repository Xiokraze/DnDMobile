namespace DnDMobile.Classes.ItemsFolder
{
    ...
    public class GeneralItem : Item
    {
        ...
        public GeneralItem(string descr, string value, string weight, ItemTypes type) : base(descr, value)
        {
            this.Description = descr;
            this.Value = value;
            this.Weight = weight;
    ...
    public class Weapon : GeneralItem
    {
        ...
        public Weapon(string descr, string value, string dmg, string weight, string properties, ItemTypes type) : base(descr, value, weight, type)
        {
            this.Description = descr;
            this.Value = value;
            this.Damage = dmg;
    ...
    public class Armor : GeneralItem
    {
        ...
        public Armor(string descr, string value, string ac, string str, string stealth, string weight, ItemTypes type) : base(descr, value, weight, type)
        {
            this.Description = descr;
            this.Value = value;
            this.ArmorClass = ac;
